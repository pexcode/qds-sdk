...
class QDSystem {
    ...
    async getCompanyListOfCity(cityId) {
        const { result, error } = await (0, api_handler_1.ApiCall)(() => SdkExternalControllerService_1.SdkExternalControllerService.getListOfCity(cityId));
        if (result) {
            return result;
        }
        throw error;
    ...
    async MyInfo() {
        const { result, error } = await (0, api_handler_1.ApiCall)(() => SdkExternalControllerService_1.SdkExternalControllerService.getMyInfo());
        if (result) {
            return result;
        }
        throw error;
    ...
    async getTenantBranches() {
        const { result, error } = await (0, api_handler_1.ApiCall)(() => SdkExternalControllerService_1.SdkExternalControllerService.getTenantBranches());
        if (result) {
            return result;
        }
        throw error;
    ...
    async CalculateCost(params) {
        const { result, error } = await (0, api_handler_1.ApiCall)(() => SdkExternalControllerService_1.SdkExternalControllerService.calculateCost(params));
        if (result) {
            return result;
        }
        throw error;
